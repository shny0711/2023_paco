import argparse
from algo.sac import SAC, MLPSAC , MHL_SAC_F
import gym
import robel
...
class HighEnv(HighInfoEnv, MHL_SAC_F):
    def __init__(self, env):
        super().__init__(env)
        #以下いらん？
        self.action_space = Box(low=np.full(4, -1), high=np.full(4, 1), shape=None,  dtype=np.float32)
...
if __name__  == "__main__":
    ...
    parser.add_argument("--path", default="/home/shunya/dev/2023_11_paco/data/MarathonFric0.1-v0/MHL_SAC_F/20240126_010338/best")
    ...
    hl_sac = MHL_SAC_F.load(args.path)
